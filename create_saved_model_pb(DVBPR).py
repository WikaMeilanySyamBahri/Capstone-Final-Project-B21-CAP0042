...
# Freeze the graph
save_path="/home/checkpoint/" #directory to model files
MODEL_NAME = 'Freeze_model' #name of the model optional
input_graph_path = save_path+'savegraph.pbtxt'#complete path to the input graph
checkpoint_path = save_path+'DVBPR_auc_100_39728.ckpt' #complete path to the model's checkpoint file
